                  ...
                  <div class="dropdown-menu">
                    <div class="dropdown-menu-columns">
                      <div class="dropdown-menu-column">
                        <a class="dropdown-item" href="<?= base_url('admin/data_siswa/siswa.php')?>">
                          Siswa
                        </a>
                        <a class="dropdown-item" href="<?= base_url('admin/data_orangtua/orangtua.php')?>">
                          Orang Tua
                        </a>
                        <a class="dropdown-item" href="<?= base_url('admin/data_admin/admin.php')?>">
                          Admin
                        </a>
                      </div>
                    </div>
                  ...
                  <div class="dropdown-menu">
                    <div class="dropdown-menu-columns">
                      <div class="dropdown-menu-column">
                        ...
                        <a class="dropdown-item" href="<?= base_url('admin/data_jam/jam.php')?>">
                          Jam Masuk dan Pulang
                        </a>
                        <a class="dropdown-item" href="<?= base_url('admin/data_harilibur/harilibur.php')?>">
                          Data Hari Libur
                        </a>
                      </div>
                    </div>
                  ...
                  <div class="dropdown-menu">
                    <div class="dropdown-menu-columns">
                      <div class="dropdown-menu-column">
                        ...
                        <a class="dropdown-item" href="<?= base_url('admin/presensi/rekap_presensi_persiswa.php')?>">
                          Persiswa
                        </a>
                      </div>
                    </div>
